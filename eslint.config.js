...
export default [
  ...
  // Plugins Import e regras de boas práticas
  {
    ...
    rules: {
      ...
      'no-unused-vars': ['error', { args: 'none', varsIgnorePattern: '^[A-Z_]' }], // ESLint recommended
  ...
  // Configuração do Prettier para evitar conflitos de formatação
  {
